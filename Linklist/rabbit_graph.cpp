...
void visit_rbt(INFOPTR info);                            //输出结点信息
...
bool create_gragh(gragh *G) //创建图
{
    ...
    for (i = 0; i < G->arcnum; i++)
    {
        ...
        cout << "第二个端点:" << endl;
        cin >> des2;
        insert_arc(G, des1-1, des2-1);//数组从0开始，输入的数据-1
    } //插入边
    return true;
}
